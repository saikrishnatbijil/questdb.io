...
tags: [tutorial, prometheus, kubernetes]
image: /img/blog/shared/og-google-kubernetes-engine.webp
---
...
<Screenshot
  ...
  height={320}
  src="/img/blog/2021-03-18/create-cluster.webp"
  width={400}
/>
...
<Screenshot
  ...
  height={88}
  src="/img/blog/2021-03-18/cluster-status-green.webp"
  width={650}
/>
...
<Screenshot
  ...
  height={228}
  src="/img/blog/2021-03-18/questdb-console.webp"
  width={650}
/>
...
Once port-forwarding is active, visit `localhost:9090` and check that we're able
to scrape `pg_up`:

<Screenshot
  alt="A screenshot of Prometheus monitoring the uptime of a QuestDB instance"
  height={500}
  src="/img/blog/2021-03-18/prometheus.webp"
  width={650}
/>
...
<Screenshot
  ...
  height={230}
  src="/img/blog/2021-03-18/velero-backups.webp"
  width={650}
/>
