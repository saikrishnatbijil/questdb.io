...
keywords:   
  ...
  - CI/CD
  - open source
tags: [engineering, troubleshooting, CI/CD, open source, maven]
slug: maven-troubleshooting-open-source
image: /img/blog/2023-03-01/xkcd_dependency.webp
---
...
<Banner
  ...
  height={433}
  src="/img/blog/2023-03-01/xkcd_dependency.webp"
  width={650}
></Banner>
...
![A screenshot from Slack where I say: the Maven connection reset issues should be fixed for all new PR builds. Let me know if you experience it again.](/img/blog/2023-03-01/slack1.webp)

It took less than 30 minutes, and we got another failure:
![A screenshot from Slack where my colleague says: It didn't help](/img/blog/2023-03-01/slack2.webp)
