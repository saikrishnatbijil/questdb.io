...
keywords:
  ...
  - loki
  - prometheus
image: /img/blog/2022-12-13/banner.webp
tags:
  [
    kubernetes,
    database,
...
<Banner
  ...
  height={467}
  src="/img/blog/2022-12-13/banner.webp"
  width={650}
>
...
<Screenshot
  ...
  height={360}
  src="/img/blog/2022-12-13/overview.webp"
  width={650}
/>
...
![Grafana login](/img/blog/2022-12-13/grafana-login.webp)

Once you've logged in, use the sidebar to navigate to the "data sources" tab:

![Grafana](/img/blog/2022-12-13/grafana-main-page.webp)

Here, you can see that the Loki data source is already registered for us:

![Grafana data sources](/img/blog/2022-12-13/grafana-data-sources.webp)
...
![Grafana data source config](/img/blog/2022-12-13/grafana-data-source-config.webp)
