...
image: /img/blog/shared/og-influxdb.webp
---
...
data structure, so when the total number of time series becomes high reading
...
<Screenshot
  alt="High-cardinality results comparing QuestDB and InfluxDB using the time series benchmark suite"
  height={385}
  src="/img/blog/2021-11-29/timeseries-benchmark-suite-throughput.webp"
  width={850}
