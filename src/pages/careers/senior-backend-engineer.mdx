...
as a service (DBaaS) solution. You will bring your expertise to build
the QuestDB DBaaS offering in close collaboration with
the rest of the cloud engineering team.
...
- 4+ years of experience building applications in Python or GO
